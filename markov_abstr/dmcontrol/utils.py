...
def set_cuda_configuration(gpu):
    """
    Sets up the cuda configuration as needed by run_lstm_vae.py and train_vae.py
    """
    if gpu == -1:
        ...
        raise RuntimeError("Invalid CUDA index specified.")
